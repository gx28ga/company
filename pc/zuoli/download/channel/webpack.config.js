let webpack = require('webpack'),
    ...
    local = '',
    http = 'https://h5.zuoli360.com/download/channel/';
const postcss = {
    plugins: [
...
const output = '../../../../pc/www/zuoli/download/';
module.exports = {
	devServer: {
		...
		proxy: {
			'\*': {
				target: 'http://101.132.162.82:101',
    ...
    output: {
	    path: path.join(__dirname, build ? output+'/channel' : "/web"),
