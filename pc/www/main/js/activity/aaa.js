...
/* cp079 */
routerApp.controller('aaaCtrl', ['$scope','$location','$filter','resourceService',function($scope,$location,$filter,resourceService) {
	...
	resourceService.queryPost($scope,$filter('交互接口对照表')('用户信息'),{},'用户信息');
	$scope.refresh();
