...
/*lee 资产记录*/
mainModule.controller('accountMyassetsWrapCtrl', ['$rootScope','$scope','$filter','resourceService','$css',function($rootScope,$scope,$filter,resourceService , $css) {
	$css.add('/main/css/stylesheets/bootstrap-sass-3.3.7/calendar.css');
	$rootScope.$broadcast('myEvent.WHDR_Ctrl',{name:'我的资产',url:'main.myAccount.myAssets'});
	$scope.page={};
	$scope.page.pageOn=1;
