window.shakeCoinsTree = function ($scope, $rootscope, $filter, resourceService, $timeout, $resource, $location, $localStorage, getScript) {
  ...
  var URL = {
    //摇钱树
    'activityStatus':'activity/status.do',
    'isChannel':'activity/participate.do',
    'prizeList':'activity/thxg/prizes.do',
    'lotteryDraw':'activity/thxg/member-raffle.do',
    'exchange':'activity/thxg/exchange-prize.do',
    'address':'activity/thxg/address-add.do',
    'diamondDetails':'activity/thxg/goldcoin-detail.do',
     'remainDiamonds':'activity/thxg/remain-goldcoin.do'
  },
  thisIndex = 0;
  getScript(['/activity/web/shakeCoinsTree/js/jquery.paging.js','/activity/web/shakeCoinsTree/js/template.js'],function(){
    thisIndex++;
    if(thisIndex == 2){
      var app = {
              init: function () {
