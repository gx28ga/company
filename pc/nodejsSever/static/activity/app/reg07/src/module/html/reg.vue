<style scoped>
	...
	.form{color: #c7711b; margin: 0 auto; a{color: #ffb400;}}
	input{ border-radius: 5px;color: #c7711b; border: 2px solid #ffb400;box-shadow: inset 1px 1px 8px 0px #ccc ; background: #cfcfcf;
		&.check{ display: inline-block; ;display: -webkit-inline-block; }
		.shadow{box-shadow: 0 0 11px #86b4cf;}
	}
	.error{ color: #ffb400; }
	input::-webkit-input-placeholder {color: #c7711b; font-size: 16px;}
	input:-ms-input-placeholder {color: #c7711b; font-size: 16px;}
	input:-moz-placeholder {color: #c7711b; font-size: 16px;}
	input::-moz-placeholder {color: #c7711b; font-size: 16px;}
	.tjr{ color: #ffb400; display: block; }
				...
				if(reg.test(this.items.pass)==false){
                    ...
                    T.ajax({ 
		                ...
		                data : {
                			...
                			checkbox: self.agree,
                			recommPhone: self.items.referee,
                			toFrom: T.toFrom
		                },
		                callback:true,
		                success : function( _data ){
...
<template>
<div class="form img-size" data-width='620'>
    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-width="598" data-height='96' type="text" v-model="items.phone" ref="phone" placeholder="请输入手机号" v-on:input="phoneInFun" v-on:blur="phoneBlurFun"/>
	<div class="phonErr error img-size" data-marginTop='8' data-fontSize='24' ></div>
    <input class="img-size" data-fontSize="32" data-marginTop="25"data-paddingLeft="22" data-width="376" data-height='96' type="text" v-model="items.imgCode" ref="imgCode" placeholder="请输入图片验证码" v-on:blur="imgCodeBlurFun"/>
	<img class="img-size" data-width="200" data-marginTop="25" data-height="100" style="display: block;float: right;" @click='changeIMG(event)' src="/login/validateCode.do" alt="">
	<div class="imgErr error img-size" data-marginTop='8' data-fontSize='24'></div>

    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="376" data-height='96' type="text" v-model="items.msg" ref="msg" placeholder="请输入短信验证码" v-on:input="msgInFun" v-on:blur="msgBlurFun"/>
	<span id="yzd" class="yzd again2 img-size" data-fontSize='30' data-width="200" data-lineHeight="100" data-marginTop="26" data-marginLeft="10" @click='sendCode(obj)'>获取验证码</span>
	<div class="msgErr error img-size" data-marginTop='8' data-fontSize='24'></div>

    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="598" data-height='96' type="password" v-model="items.pass" ref="pass" placeholder="密码建议6-18位数字、字母组合" v-on:input="passInFun" v-on:blur="passBlurFun"/>
	<div class="passErr error img-size" data-marginTop='8' data-fontSize='24'></div>

	<div class="tjr img-size" data-fontSize="32" @click='showreff'><span class="sjx img-size" data-borderLeftWidth="12" data-borderRightWidth="12" data-borderTopWidth="24" data-marginRight='5' v-show='showref==false'></span><span class="sjx2 img-size" data-borderLeftWidth="12" data-borderRightWidth="12" data-borderBottomWidth="24" data-marginRight='5' v-show='showref==true'></span>推荐人（可不填）</div>
    <input class="img-size" v-show="showref==true" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="598" data-height='96' type="text" v-model="items.referee" ref="referee" placeholder="推荐人手机号(可不填)" v-on:input="refereeInFun"/>
	<div class="refereeErr error img-size" data-marginTop='8' data-fontSize='24'></div>
    ...
    <div class="regbtn img-size" data-width='620' data-lineHeight="88" data-marginTop="25" data-fontSize="44"  @click='submit'>立即领取大礼包</div>
</div>
</template>