...
var T = {
    ...
    ,setImgSize : function(){
        ...
        $('.img-size').each(function(){
            var self = $(this);
            $.each(['maxWidth','borderBottomLeftRadius','borderBottomRightRadius','borderRadius','height','width','fontSize','left','right','bottom','top' , 'paddingTop' ,'lineHeight' , 'paddingLeft' , 'paddingRight' , 'paddingBottom','marginTop', 'marginLeft' , 'marginRight' , 'marginBottom'],function( i , str ){
