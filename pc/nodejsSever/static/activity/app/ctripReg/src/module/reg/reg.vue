<style scoped>
	...
	.form{color: #004a6c; a{color: #c72839;}}
	input{ border: 0; border-radius: 5px; margin: 0 auto; display: block;color: #004e66;
		&.check{ display: inline-block; display: -webkit-inline-block; }
		.shadow{box-shadow: 0 0 11px #86b4cf;}
	}
	.error{ color: #c20e0e; }
	input::-webkit-input-placeholder {color: #004e66; font-size: 16px;}
	input:-ms-input-placeholder {color: #d3d3d3; font-size: 16px;}
	input:-moz-placeholder {color: #d3d3d3; font-size: 16px;}
	input::-moz-placeholder {color: #d3d3d3; font-size: 16px;}
	...
	.img-box{border-left: 1px solid #004a6c; float: right; display: inline-block;display: -webkit-inline-block;}
	.regbtn{ color: #700004; text-align: center; width: 100%; background: url('../../images/lqbg.png') no-repeat; background-size: contain; background-position: center; }
	.box{ margin:0 auto; }
</style>
<script>
...
<template>
<div class="form">
    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-width="596" data-height='82' type="text" v-model="items.phone" ref="phone" placeholder="请输入手机号" v-on:input="phoneInFun" v-on:blur="phoneBlurFun"/>
	...
	<div class="box img-size" data-width="618">
	    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="596" data-height='82' type="text" v-model="items.imgCode" ref="imgCode" placeholder="请输入图片验证码" v-on:blur="imgCodeBlurFun"/>
		<div class="img-box img-size" data-height="60" data-marginTop="-70" data-paddingLeft='35' data-paddingRight='35'><img @click='changeIMG(event)' src="/login/validateCode.do" alt=""></div>
	</div>
	<div class="imgErr error img-size" data-marginTop='8' data-fontSize='24' data-paddingLeft='66'></div>
	<div class="box img-size" data-width="618">
	    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="596" data-height='82' type="text" v-model="items.msg" ref="msg" placeholder="请输入短信验证码" v-on:input="msgInFun" v-on:blur="msgBlurFun"/>
		<div class="img-box img-size" data-height="60" data-marginTop="-70" data-paddingLeft='15' data-paddingRight='15' data-lineHeight='60'><span id="yzd" @click='sendCode(obj)'>获取验证码</span></div>
	</div>
	<div class="msgErr error img-size" data-marginTop='8' data-fontSize='24' data-paddingLeft='66'></div>
    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="596" data-height='82' type="password" v-model="items.pass" ref="pass" placeholder="密码建议6-18位数字、字母组合" v-on:input="passInFun" v-on:blur="passBlurFun"/>
    ...
    <input class="check tjr img-size" data-marginLeft="66" data-fontSize="32" data-marginTop="25" type="checkbox" v-model="agree" name="agree" true-exp="a" false-exp="b"  v-on:change="agreelocked"/>我已阅读并同意<a href="https://www.duorongcf.com/zc">《注册协议》</a>
	<div style="text-align: center;" class="regErr error img-size" data-marginTop='8' data-fontSize='24'></div>
    <div class="regbtn img-size" data-height="107" data-lineHeight="95" data-marginTop="25" data-fontSize="44" @click='submit'>立即领取10M流量</div>
</div>
</template>