...
<template>
  <div>
    ...
    <template v-if="isLogin">
      <gift-setting v-if="tabIndex == 1"></gift-setting>
    ...
    <div class="bottom-bar img-size" data-left="-125" data-width="1000" data-height="104" data-bottom="0" data-fontSize="30" data-lineHeight="104">
      <div class="img-size tab" data-width="187" :class="tabIndex == 0 ? 'focus' : 'blur'" @click="tabIndex = 0">红包雨</div><!--
   --><div class="img-size tab" data-width="187" :class="tabIndex == 1 ? 'focus' : 'blur'" @click="tabIndex = 1">奖品设置</div><!--
   --><div class="img-size tab" data-width="187" :class="tabIndex == 2 ? 'focus' : 'blur'" @click="tabIndex = 2">排行榜</div><!--
   --><div class="img-size tab" data-width="187" :class="tabIndex == 3 ? 'focus' : 'blur'" @click="tabIndex = 3">我的奖品</div>
    </div>
  </div>
</template>
<script>
    ...
    export default {
        ...
        components : {
            ...
            'giftSetting' : function (resolve) {
                require(['./giftSetting'], resolve);
            },
            'my' : function (resolve) {
