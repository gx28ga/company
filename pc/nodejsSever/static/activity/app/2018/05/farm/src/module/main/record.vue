...
<template>
  <div class="main-section">
    <div class="img-size record-wrapper" data-width="750" data-height="1334">
      ...
      <div class="img-size record-area" data-top="180" data-left="50">
        <div class="row img-size" data-fontSize="30" data-lineHeight="120">
          <div class="img-size" data-width="363" data-marginRight="36">奖 品</div><!--
           --><div class="img-size" data-width="252">获奖时间</div>
        </div>
      </div>
      <template v-if="myRcds.length > 0">
        <div class="record-area img-size" data-top="300" data-left="50">
          <div v-for="(page, no) in rcdPages">
            <div v-show="pgIndex == no" v-for="row in page" class="row img-size" data-fontSize="30" data-lineHeight="60">
              <div class="img-size" data-width="363" data-marginRight="36">{{row.giftName}}</div><!--
           --><div class="img-size" data-width="252">{{row.addTime | transferTimeStr}}</div>
            </div>
          </div>
        </div>
        <div class="pager-box img-size" data-top="920">
      ...
      <div v-show="myRcds.length <= 0" class="section img-size" data-top="580">
