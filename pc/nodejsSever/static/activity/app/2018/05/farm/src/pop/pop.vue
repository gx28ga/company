...
<transition :name="transition">
    <div v-show='showModal' class="modal-mask" v-bind:class='superClass' @click='closePop'>
        <div class="modal-wrapper">
            <div class="modal-container img-size" data-width='619' data-height='1107' @click='closePropagtion($event)'>
                <slot name="close">
                    <div id="close-pop" class="close img-size" data-width='80' data-height='80' data-top='5' data-right='5' @click='closePop'></div>
                </slot>
