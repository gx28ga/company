...
<template>
  <div class="main-box img-size" data-width="750" data-height="3329">
    ...
    <template v-if="isLogin == false">
      ...
      <div class="invest-on-btn time img-size" data-width="256" data-height="64" @click="login"></div>
    </template>
    <template v-else>
      <div v-show="currentStatus == true" class="invest-on-btn current img-size" data-width="256" data-height="64" @click="onInvestCurrentNew"></div>
      <div v-show="currentStatus == false" class="invest-off-btn current img-size" data-width="256" data-height="64"></div>
      <div v-show="timeStatus == true" class="invest-on-btn time" @click="onInvestTimeNew"></div>
      <div v-show="timeStatus == false" class="invest-off-btn time"></div>
    </template>
  </div>
</template>
<script>
