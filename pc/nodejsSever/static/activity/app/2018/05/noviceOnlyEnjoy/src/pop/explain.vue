    ...
    <div v-show='showModal' class="modal-mask explain flip-top" @click='closePop'>
        <div class="modal-wrapper">
            <div class="modal-container pop-cnt img-size" data-paddingTop='126' data-paddingLeft='50' data-width='600' data-height='689' @click='closePropagtion($event)'>
                ...
                <div class="content img-size" data-lineHeight="36">
                    <div>1、活动时间：即日起</div>
                    <div>2、活动仅针对活动期间内新注册的用户</div>
                    <div>3、注册即送</div>
                    <div>①1588元红包：20元红包+268元红包+300元红包+1000元红包组合，红包将即时发放到您的账户，请在有效期内使用。红包可用于投资时使用，投资生效后将以现金的形式返到您的账户</div>
                    ...
                    <div>4、短期新手体验产品：仅限新用户首笔投资，每人最高可购买额度50000元。例如注册成功后，首笔投资了其他产品，则无法投资新手体验短期产品</div>
                    <div>5、新手专享产品：每个产品仅限新用户投资1次，每人最高可购买额度为50000元</div>
                    <div>6、想获得更多福利，了解更多活动信息，请联系4006-908-896，同时您也可以等待您的专属理财师电话联系！</div>
                    <div>7、本次活动最终解释权归多融财富所有</div>
                </div>
            </div>
        </div>
    </div>
