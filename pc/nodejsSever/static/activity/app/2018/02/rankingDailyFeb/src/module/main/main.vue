...
<template>
  <div class="ranking-main-box img-size" data-width="750" data-height="2988">
    ...
    <template v-if="isLogin">
      <div class="mine img-size" data-top="425" data-left="75" data-fontSize="24" data-lineHeight="40">
        我的元宵数量：<span>{{myInvest > 0 ? myInvest : '暂无'}}</span><i v-show="todayDate.length > 0">　({{todayDate | formatDate}})</i><br>
    ...
    <div class="final-rank img-size" data-top="1190" data-left="207" data-width="336" data-height="52" @click="onFinalRank"></div>
  </div>
</template>
<script>
