...
var T = {
    ...
    ,setImgSize : function(){
        ...
        $('.img-size').each(function(){
            var self = $(this);
            $.each(['height', 'minHeight', 'width','left','right','bottom','top' , 'padding', 'paddingTop' ,'lineHeight' , 'paddingLeft' , 'paddingRight' , 'paddingBottom','marginTop', 'marginLeft' , 'marginRight' , 'marginBottom', 'fontSize', 'borderRadius', 'borderTopLeftRadius', 'borderBottomLeftRadius'],function( i , str ){
