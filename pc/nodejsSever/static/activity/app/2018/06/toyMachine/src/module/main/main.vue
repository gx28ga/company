<style lang='sass'>
  ...
  .bottom-bar.home{
    @include contain("../../images/footbar-home.png");
  }
  .bottom-bar.rank{
    @include contain("../../images/footbar-rank.png");
  }
  .bottom-bar.xchg{
    @include contain("../../images/footbar-xchg.png");
  }
  .bottom-bar.my{
    @include contain("../../images/footbar-my.png");
  }
</style>
<template>
  <div>
    <home v-if="tabIndex == 0" @consult-records="tabIndex = 3"></home>
    <template v-if="isLogin">
      <xchg v-if="tabIndex == 1" @xchg-request-error="tabIndex = 0"></xchg>
      <rank v-if="tabIndex == 2"></rank>
      <my v-if="tabIndex == 3" @record-error="tabIndex = 0"></my>
    </template>
    <div class="bottom-bar img-size" :class="['home', 'xchg', 'rank', 'my'][tabIndex]" data-width="750" data-height="132" data-bottom="0"></div>
    <div class="img-size click-area" data-width="710" data-height="141" data-left="20" data-bottom="15">
