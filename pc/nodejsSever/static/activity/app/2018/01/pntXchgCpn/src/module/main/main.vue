<style lang='sass'>
  ...
  .bg{
    @include contain("../../images/bg1.jpg");
    position: relative;
    .btn{
      position: absolute;
    }
...
<template>
  <div class="bg img-size" data-width="750" data-height="1780">
    <div v-show="!isLogin" class="btn img-size" data-top="560" data-left="130" data-width="464" data-height="110" @click="login"></div>
    <div v-show="isLogin" class="btn img-size" data-top="540" data-left="130" data-width="520" data-height="140" @click="onGoPointMall"></div>
  </div>
</template>
<script>
