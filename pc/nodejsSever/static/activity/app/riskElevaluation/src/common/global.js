...
var T = {
   ...
   // ,duorongHttp : 'http://api-test.duorongcf.com'
   ...
   // ,imgsrc : 'http://pc-test.duorongcf.com'
    ...
    ,callApp : {
        ...
        ,invite:function(){
            window.location.href='http://pc-test.duorongcf.com/activity/app/inviteFriend?uid='+T.uid;
        }
        ...
        ,account:function(){//去我的账户
             T.getAppInfo();
            if(T.wap){
                 window.location.href='http://app.duorongcf.com';
            }else{
                window.location.href='jump://page=11?';
            }
        }
    }
