...
module.exports = {
    ...
    externals : {
        'Vue' : 'window.Vue',
        '$' : 'window.$',
        //'Promise' : 'window.ES6Promise.Promise'
    },
    output: {
        path: path.join(__dirname, build ? '../../../../www/activity/app/2017ChildrensDay/ftp' : "../../../../www/activity/app/2017ChildrensDay/build"),
...
if (build) {
    module.exports.plugins = (module.exports.plugins || []).concat([
        ...
        new CleanPlugin('../../../../www/activity/app/2017ChildrensDay/ftp')
    ])
} else {
