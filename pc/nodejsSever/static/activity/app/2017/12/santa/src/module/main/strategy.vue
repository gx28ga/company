...
<template>
  <div class="strategy-main flip-left-bounce">
    <div class="img-size content-wrapper" data-width="750" data-height="1334">
      ...
      <!--<div class="investment img-size" data-top="930" data-left="110" data-fontSize="18" data-lineHeight="18">您当前累计投资：<span>{{investedAmt}}</span>元<br><br><a v-show="gapAmt > 0">距离开启【金色笑脸】还差<span>{{gapAmt}}</span>元</a><a v-show="gapAmt <= 0">已开启【金色笑脸】</a></div>-->
      <div class="main-btn img-size" data-top="840" data-left="225" data-width="300" data-height="84" @click="onBack"></div>
    </div>
  </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getMyInvest: function () {
                ...
                this.investedAmt = _data.map.current;
                this.gapAmt = _data.map.gap;
            });
            },
            onBack : function () {
