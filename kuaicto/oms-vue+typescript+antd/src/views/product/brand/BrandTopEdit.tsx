...
export default class BrandTopEdit extends Vue {
    private ref!: any;
    ...
    public render() {
        return (
            <k-top-edit>
                <div slot="left">
                    <a-button icon="plus" type="primary" onClick={this.add}>新增</a-button>
                    <a-modal
                        title="新增品牌"
                ...
                <div slot="right">
                    <a-form layout='inline' autoFormCreate={(form: any) => {
                        ...
                        >
                            <a-input addonBefore="品牌" placeholder="请输入品牌"/>
                        </a-form-item>
                        <a-form-item
                            {...{props: this.formTailLayout}}
                        >
                            <a-button icon="search" type='primary' onClick={this.check}>搜索</a-button>
                        </a-form-item>
                    </a-form>
                </div>
            </k-top-edit>
