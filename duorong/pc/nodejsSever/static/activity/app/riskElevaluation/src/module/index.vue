...
<div class='transition'>
    ...
    <div class='returnNext img-size' data-fontSize='32' data-paddingLeft='40' data-marginTop='30' @click='goback' v-show='current !==1 && result !=2 && result !=3' data-width='200'>< 返回上一题</div>
    <div class='disBtn  img-size' data-width='490' data-height='90' data-lineHeight='90' data-fontSize='36' v-show='current ==10 && btn ==5 && result !=2' >提交</div>
    <div class='submitBtn img-size' data-width='490' data-height='90' data-lineHeight='90' data-fontSize='36' v-show='current ==10  && result !=2 && btn==3'  @click='submitBtn'>提交</div>

    <div class='returnRisk img-size' data-width='490' data-height='90' data-fontSize='28' data-lineHeight='90' @click='returnRisk' v-show='result ==3'>重新测评</div>
    <div class='returnRisk img-size' data-width='490' data-height='90' data-fontSize='28' data-lineHeight='90' @click='returnMyAccount' v-show='result ==2'>返回</div>
    </div>
</div>
</template>
<script>
...
import {riskEvaluation,riskUrl} from "../common/URL.js";
                 ...
                 if(this.allValue['question10']!=undefined){
                    ...
                    for(var item in riskResult){
                     ...
                     if(A.length >7 || A.length ==7){
                        ...
                        var self=this;
                        T.ajax({
                            data:{uid:T.uid,isRisk:self.number},
                            url:riskEvaluation,
                            callback:true
                        }).then(data=>{
                            if(data.success){
