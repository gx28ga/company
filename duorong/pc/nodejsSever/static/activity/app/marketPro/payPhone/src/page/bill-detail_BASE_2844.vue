<style scoped>
    ...
    .module-scroll{ background: #f6f6f6; 
        .bill-top{ position: relative; color: #fff; background: url('../images/topbg.png') no-repeat; background-size: contain;
			p{ text-align: center; &:nth-child(1){ color:#333; text-align: left; span{ background:#ffebda ; color:#ff9a5e; border-radius: 5px; }} &.nh{ color: #ff681b; span{ font-family: 'Arial'; } }
	...
	export default {
		...
		mounted(){
	  		...
	  		T.ajax({
	  			...
	  			this.info = data.map.currentInfo;
	  		})
	  	},
	  	methods :{
...
<template>
    <div class='module-scroll'>
	    ...
	    <div class="bill-top img-size" data-paddingLeft='36' data-paddingRight='36' data-height='381'>
	    	<p class="img-size" data-lineHeight='106' data-fontSize='36' data-paddingLeft='90'>新手宝<span class="img-size" data-fontSize='22' data-marginLeft='30' data-paddingLeft='10' data-paddingRight='10'>首投专享</span><span class="img-size" data-fontSize='22' data-marginLeft='20' data-paddingLeft='10' data-paddingRight='10'>首周加息5%</span></p>
	    	<p class="nh img-size" data-fontSize='48' data-lineHeight='40' data-paddingTop='40'><span class="img-size" data-fontSize='120'>{{info.rate}}</span>%<i class="img-size" data-fontSize='72'>+</i><span class="img-size" data-fontSize='120'>{{info.extraRate}}</span>%</p>
	    	<p class="img-size" data-fontSize='30' style="color:#a9a9a9;">随时退出 随时提现</p>
	    	<p class=" qt img-size" data-lineHeight='45' data-paddingLeft='20' data-marginTop='30'>如投资5万元，每日收益<span>13.68</span>元（首周）</p>
	    </div>
	    <div class="bill-info img-size" data-paddingLeft='32' data-paddingRight='32' data-paddingBottom='60' data-marginTop='20' data-marginBottom='20'>
	    	...
	    	<div class="img-size" data-lineHeight='78'>起投金额<span>{{info.leastPurchaseAmount | currency}}元，且以{{info.increasedAmount | currency}}的倍数递增</span></div>
	    	<div class="img-size" data-lineHeight='78'>最大金额<span>{{info.maxPurchaseAmount | currency}}</span></div>
	    	<div class="img-size" data-lineHeight='78'>转入说明<span>今日购买次日计息</span></div>
	    	<div class="img-size" data-lineHeight='78'>转出说明<span>申购确认后随时退出</span></div>
	    </div>
	    <div class="safe img-size" data-marginBottom='10' data-paddingTop='29' data-paddingBottom='25'>
    		<div class="img-size" data-width='690' style="margin:0 auto;">
	    		<div class="safekuai " >
	    			...
	    			<span class="img-size" data-fontSize='20'>华瑞银行存管</span>
	    		</div>
	    		<div class="safekuai">
	    		...
	    		<div class="safekuai" >
	    			...
	    			<span class="img-size" data-fontSize='20'>历史产品均如约兑付</span>
	    		</div>
    		</div>
	    </div>
		...
		<div class="img-size" data-marginBottom='130' data-paddingLeft='30'>
		    ...
		    <span class="img-size" data-fontSize='24'>我已阅读并同意<a href="https://www.duorongcf.com/current">《活期投资协议》</a></span>
		</div>
	    <div class="float img-size" data-lineHeight='120' data-fontSize='36'>
		    <input type="number" class="img-size" data-paddingLeft='23' placeholder="100元起投，百元递增" data-height='68' data-fontSize='36' data-lineHeight='68' data-width='489' data-borderRadius='8' data-marginRight='10' v-model="amount" ref="amount" v-on:input="amountFun">
