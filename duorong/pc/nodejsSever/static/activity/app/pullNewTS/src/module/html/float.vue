...
<div>
	<div class="bannbox img-size" data-height="170" style="width: 100%;position: fixed;bottom: 0;">
		<div class="bga">
			<input class="phon img-size" data-fontSize="32" data-width="370" data-height="80" data-marginTop="40" data-marginLeft="48" data-paddingLeft="30" data-borderRadius='50' type="text" v-model="items.phone" ref="phone" placeholder="请输入手机号" v-on:input="phoneInFun" />
			<div class="btn lqbtn img-size" data-width="220" data-lineHeight="80" data-right="48" data-top="40" data-borderRadius='40' data-fontSize="32" @click="tzphone">立即领取</div>
