  ...
  <div class="main-section">
    <div class="img-size record-wrapper" data-width="750" data-height="1334">
      ...
      <template v-if="myRcds.length > 0">
        <div class="record-area img-size" data-top="155" data-left="67">
          <div v-for="(page, no) in rcdPages">
            <div v-show="pgIndex == no" v-for="row in page" class="row img-size" data-fontSize="24" data-lineHeight="48">
              <div class="img-size" data-width="340">{{row.giftName}}</div><!--
           --><div class="img-size" data-width="195">{{row.addTime | transferTimeStr}}</div>
            </div>
          </div>
        </div>
        <div class="pager-box img-size" data-top="680">
      ...
      <div v-show="myRcds.length <= 0" class="section img-size" data-top="300">
