<style lang='sass' scoped>
  ...
  .main-section {
    ...
    .content-wrapper {
      ...
      .hlt{color: #ff6400;}
      .init-player{
        @include contain("../../images/jianzi-player.png");
      }
      .anm-player{
        @include contain("../../images/anm-1.gif");
      }
      .play-box{
        z-index: 9;
        width: 100%;
  ...
  <div>
    ...
    <div v-show="beginCounter <= 0" class="main-section">
      <div class="img-size content-wrapper" data-width="750" data-height="1334">
        ...
        <div v-show="!isPushing || miliseconds >= roundTime || miliseconds <= 0" class="img-size init-player" data-top="440" data-left="30" data-width="550" data-height="576"></div>
        <div v-show="isPushing && miliseconds < roundTime && miliseconds > 0" class="img-size anm-player jianzi" data-top="336" data-left="0" data-width="750" data-height="681"></div>
