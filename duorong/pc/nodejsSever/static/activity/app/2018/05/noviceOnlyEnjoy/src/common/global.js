...
var T = {
    ...
    ,callApp : {
        ...
        ,currentNovice : function () {  //去活期新手宝详情
            if(T.wap){
                window.location.href=T.duorongHttp+'/html/2weima.html';
            }else{
                window.location.href='jump://page=39?';
            }
        }
        ,timeNovice : function (params) { //去定期新手专享详情
            if(T.wap){
                window.location.href=T.duorongHttp+'/html/2weima.html';
            }else{
                window.location.href='jump://page=9?pid=' + params.pid + '&type=' + params.type + '?';
            }
        }
    }
