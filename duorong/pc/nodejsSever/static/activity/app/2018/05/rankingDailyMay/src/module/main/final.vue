  ...
  <div class="main-section">
    <div class="img-size rank-wrapper" data-width="750" data-height="1334">
      ...
      <div class="my-area img-size" data-top="420" data-left="75" data-fontSize="20" data-lineHeight="40">
        <div>我的财富值：<span :class="myDumpling > 0 ? 'img-size' : ''" data-fontSize="24">{{myDumpling > 0 ? myDumpling : '暂无'}}</span></div>
      ...
      <div class="list-area img-size" data-top="720" data-left="68">
       ...
       &ndash;&gt;<div class="img-size" data-width="220">奖 品</div>
        ...
        <div v-show="rankList.length > 0" v-for="(item, i) in rankList" :key="item.rowNum" class="row img-size" :class="myRank == item.rowNum ? 'highlight' : ''" data-fontSize="24" data-lineHeight="50">
       ...
       --><div class="img-size" data-width="228" data-fontSize="20">{{item.gift}}</div>
        </div>
      </div>
      <div v-show="rankList.length > 0" class="section comment img-size" data-top="1240" data-left="100" data-width="585" data-fontSize="16" data-lineHeight="30">* 榜单实时展示，榜单结果以活动结束日23:59最终结果为准，其余时间仅供参考</div>
