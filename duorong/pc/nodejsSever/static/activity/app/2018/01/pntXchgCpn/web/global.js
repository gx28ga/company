...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"4":"app"}[chunkId]||chunkId) + "_chunk.js?name=" + "0537a83d152e9a16371f" + "";
...
var T = {
    ...
    // ,imgsrc : 'http://192.168.0.72'
    // ,duorongHttp : 'http://192.168.0.72'
    ...
    callApp: {
        ...
        pointMall: function pointMall() {
            //去积分商城
            if (T.wap) {
                window.location.href = T.duorongHttp + '/html/2weima.html';
            } else {
                window.location.href = 'jump://page=34?';
            }
        }
    },
    goPage: function goPage(step, start) {
        ...
        if (hash.search(match) > -1 && hash.match(match)[0].substr(2) == module) {
            this.$refs.road.setRoad(step, start, num);
            this.$refs.progressBar.upstep();
            this.$refs.dice.update();
        } else {
                        ...
                        if (!T.errorPop) {
                            ...
                            /*require.ensure([],(require)=>{
                                ...
                                new pop({
                                    title : '',
                                    width:'70%',
                                    content : '<center>'+(data.errorMsg||'操作失败，请联系客服！')+'</center>',
                                    okBtn : true,
                                    cancelBtn:false,
                                    okTxt:'确定',
                                    timing : 'errorcur'
    ...
    load: function load() {
        ...
        if (timing == 'lightLoader') {
            ...
            __webpack_require__.e/* require.ensure */(2).then((function () {
                var lightLoader = __webpack_require__(16);
                try {
            ...
            __webpack_require__.e/* require.ensure */(1).then((function () {
                var Sonic = __webpack_require__(17);
                var option = {},
                    width = 50,
                    height = 50,
                    half = width / 2;
...
module.exports = function (elementName, _data, name) {
    ...
    __webpack_require__.e/* require.ensure */(0).then((function (require) {/* WEBPACK VAR INJECTION */(function(Vue) {
        Vue.component(elementName, function () {
            return __webpack_require__(18)("./" + name + '.vue');
        });
        new Vue({
            el: '#pop .child',
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1)))}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(5), __webpack_require__(4)))
...
/***/ })
/******/ ]);
//# sourceMappingURL=global.js.map?0537a83d