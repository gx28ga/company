...
const output = '../../../../../www/activity/app';// the path(s) that should be cleaned
...
let cleanOptions = {
    root:     'E:/git/source_tree/develop/dr_pc_web/www/activity/app',
    exclude:  [],
    verbose:  true,
    dry:      false
};
module.exports = {
    entry: { 
        app : './src/main.js',
        vendor : ["Vue", "VueRouter",'zepto', 'jquery', 'global']
    },
    /*externals : {
        '$' : 'zepto-webpack',
        'Vue' : 'Vue',
    ...
    output: {
		...
		path: path.join(__dirname, build ? output+'/socialService7th' : "/web"),
       ...
       // noParse : ['./plug/'],
        rules :[
            ...
            /*    use: "url-loader?limit=8192&name=[path][name].[ext]?[hash:8]",//,'image-webpack-loader',"url-loader"	*/
				use: "url-loader?limit=10&name=[path][name].[ext]?[hash:8]",//,'image-webpack-loader',"url-loader"
            },
            {
                test: /\.js$/,
                enforce: "pre",
