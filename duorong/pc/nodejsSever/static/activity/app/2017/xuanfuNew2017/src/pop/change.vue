<style scoped>
	...
	.modal-mask.explain{
        ...
        .pice{display: flex; border: 1px solid #dddddd; position: relative;
            ...
            &.comm{ &.colors{border:0; background: #fbf6f2; } p.name{ color: #db4c5d;  } .right{
             /*background:url('../images/comm.png') no-repeat; */
             background-size: contain; } } 
            &.silver{ &.colors{border:0; background: #fbf6f2; } p.name{ color: #959595;  } .right{
             /*background:url('../images/silver.png') no-repeat;*/
              background-size: contain; } } 
            &.gold{ &.colors{border:0; background: #fbf6f2; } p.name{ color: #f79910;  } .right{
             /*background:url('../images/gold.png') no-repeat; */
             background-size: contain; } } 
            .selected{ position: absolute; &.img{ 
