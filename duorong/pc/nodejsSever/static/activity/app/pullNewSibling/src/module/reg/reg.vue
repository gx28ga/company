...
<div class="form img-size" data-width='464'>
    ...
    <input class="img-size" data-fontSize="32" data-paddingLeft="22" data-marginTop="25" data-width="438" data-height='70' type="text" v-model="items.referee" ref="referee" placeholder="推荐人手机号(可不填)" v-on:input="refereeInFun"/>
    ...
    <div class="regbtn img-size" data-width='460' data-height="70" data-lineHeight="70" data-marginTop="25" data-fontSize="32" @click='submit'>下一步</div>
</div>
</template>