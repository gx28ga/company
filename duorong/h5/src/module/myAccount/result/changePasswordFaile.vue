/**
* 修改密码
* Created by wangcuqing on 2018/3/27.
*/
<style>
...
<template>
    <div class='openAccount-content img-size' data-paddingTop='60' data-paddingBottom='60'>
      ...
      <div class='prompt img-size' data-fontSize='24' data-marginTop='26' data-marginBottom='26' data-marginLeft='60' data-marginRight='60'>由于{{errMsg}}原因，您的修改操作已失败！</div>
      <div class='btn img-size' data-width='260' data-height='80' data-lineHeight='80' data-fontSize='32' @click='prompt'>再试一次</div>
    </div>
</template>
<script>
    export default {
        ...
        methods:{
            prompt(){
                return this.go().myAccount.setting();
            }
        }
    }
</script>
